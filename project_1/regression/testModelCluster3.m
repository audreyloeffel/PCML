...
x56 = Xtrain(:, 56).^2;
x38 = Xtrain(:, 38).^2;
[rmseTr, rmseTe] = crossValidation([Xtrall normalize(x56) normalize(x38)], Ytrain, 0, lambda, 'rr', 0);
...
x56 = Xtrain(:, 56).^2;
x38 = Xtrain(:, 38).^2;
[rmseTr, rmseTe] = crossValidation([Xtr normalize(x56) normalize(x38)], Ytrain, 0, lambda, 'rr', 0);

...
% This code applies PenLogisticRegression to our classification data,
...
for k = 1:K
    ...
    %% Applying the method Pen Logistic Regression
    lambda = 5;
    alpha = 0.01;
    ...
    fprintf('\nCost using RMSE is %d',rmse(yTe,tXte,betaPen));
...
pred = tXte*betaPen; % Prediction using penalized logistic regression model

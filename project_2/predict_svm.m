...
errBinSVM = ber(yTrBin, predMulti);
fprintf('Binary SVM training error: %f', errBinSVM);
...
errMultiSVM = ber(yTr, predMulti);
fprintf('Binary SVM training error: %f', errMultiSVM);